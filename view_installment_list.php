    ...
    <div class="container form-box-md">
      ...
      <div class="row">
        <label class="col-sm-4 offset-sm-1">
          Current Balance:
          <input readonly type="text" class="form-control col-sm-12" value="<?php echo empty($remainingBalance) ? "Payment Settled" : $remainingBalance; ?>" name=""/>
        </label>
      </div>
      ...
      if (($remainingBalance != 0) && ($_SESSION['usertype'])=='Cashier'){
        ...
        <div class="row form-group">
          <div class="col-sm-4 offset-sm-4">
            <a href="add_installment.php?acctid=<?php echo $acctinfoID ?>" class="btn btn-block btn-primary btn-lg">Add Payment</a>
          </div>
        </div>
        <?php
      }
