...
<?php
  ...
  headertag("Add Staff Information");
?>
    ...
    <div class="container form-box">
      ...
      <form role="form" method="post" action="includes/add_staff.inc.php">
        ...
        <div class="row pt-sm-3">
          <div class="col-sm-2 offset-sm-5">
            <input type="submit" value="Submit" name="add_staff_submit" class="btn btn-primary btn-block"/>
          </div>
        </div>
