...
INSERT INTO installmenttab VALUES("1","40000","10000","2019-01-10","","1");
INSERT INTO installmenttab VALUES("2","30000","10000","2019-02-06","111111","1");
INSERT INTO installmenttab VALUES("3","40000","0","2019-04-04","","6");
INSERT INTO installmenttab VALUES("8","30000","10000","2019-04-05","222222","6");
INSERT INTO installmenttab VALUES("10","25000","5000","2019-04-05","333333","6");
INSERT INTO installmenttab VALUES("11","40000","0","2019-04-06","","7");
INSERT INTO installmenttab VALUES("12","30000","10000","2019-04-06","123214","7");
...
CREATE TABLE `staffsalarystatementtab` (
  ...
  CONSTRAINT `staffsalarystatementtab_ibfk_2` FOREIGN KEY (`staffsalaryID`) REFERENCES `staffsalarytab` (`staffsalaryID`),
  CONSTRAINT `staffsalarystatementtab_ibfk_3` FOREIGN KEY (`userID`) REFERENCES `usertab` (`userID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `studenttransactionstab` (
  `studtransID` int(11) NOT NULL AUTO_INCREMENT,
  `date` date NOT NULL,
  `modeOfPayment` enum('Cash','Credit','Debit','Check') NOT NULL,
  `studno` int(11) NOT NULL,
  `userID` int(11) NOT NULL,
  `amountDue` int(30) NOT NULL,
  `amountReceived` int(30) NOT NULL,
  PRIMARY KEY (`studtransID`),
  KEY `userID` (`userID`),
  CONSTRAINT `studenttransactionstab_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `usertab` (`userID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO usertab VALUES("29","testCashier","$2y$10$wnVUdXXHmTAVvSm/ANraTO5yan6yeDj3p96FbuXDhHgbJiqfrYoaK","Cashier","Enabled");
