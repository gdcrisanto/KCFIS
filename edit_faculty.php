...
<?php
  ...
  headertag("Edit Faculty Information");
?>
    ...
    <div class="container form-box">
      ...
      <form method="post" action="includes/edit_faculty.inc.php">
        <div class="row">
        ...
        <div class="row pt-sm-3">
          <div class="col-sm-2 offset-sm-5">
            <input type="submit" value="Submit" name="edit_faculty_submit" class="btn btn-primary btn-block"/>
          </div>
        </div>
      </form>
    </div>
