...
<?php
  ...
  headertag("Search Student Accounts");
?>
    ...
    <div class="container form-box">
      ...
      <form role="form" method="post" action="search_student_acct.php">
        <div class="row form-group">
          <input type="text" class="form-control col-sm-4 offset-sm-6" name="student" placeholder="search student no. or name"/>
          <div class="col-sm-2">
